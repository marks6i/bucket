...
class BucketListRangeTest : public ::testing::Test {
protected:
  void SetUp() override {
...
// Basic range tests
TEST_F(BucketListRangeTest, EmptyRange) {
  auto range = container->range(12, 18);
  EXPECT_EQ(range.begin(), range.end());
}

TEST_F(BucketListRangeTest, SingleBucketRange) {
...
TEST_F(BucketListRangeTest, MultipleBucketRange) {
...
TEST_F(BucketListRangeTest, ReverseIteratorRange) {
  auto range = container->range(5, 35);
...
// Range method tests
TEST_F(BucketListRangeTest, ContainsMethod) {
  auto range = container->range(5, 35);
...
TEST_F(BucketListRangeTest, FindMethod) {
  auto range = container->range(5, 35);
...
TEST_F(BucketListRangeTest, AtMethod) {
  auto range = container->range(5, 35);
...
TEST_F(BucketListRangeTest, NextMethod) {
  auto range = container->range(5, 35);
...
TEST_F(BucketListRangeTest, PreviousMethod) {
  auto range = container->range(5, 35);
...
TEST_F(BucketListRangeTest, ConstMethods) {
